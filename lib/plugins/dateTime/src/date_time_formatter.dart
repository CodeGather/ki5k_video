...
class DateTimeFormatter {
  ...
  static List<String> splitDateFormat(String dateFormat,
    ...
    if (mode == DateTimePickerMode.datetime && false) {
  ...
  static String formatDateTime( int value, String format, DatePickerString locale ) {
  ...
  static String formatDate(
      DateTime dateTime, String format, DatePickerString locale) {
    if (format == null || format.length == 0) {
  ...
  static String _formatYear(
      int value, String format, DatePickerString locale) {
  ...
  /// format month text
  static String _formatMonth( int value, String format, DatePickerString locale ) {
    List<String> months = locale.getMonths;
  ...
  /// format week text
  static String _formatWeek( int value, String format, DatePickerString locale ) {
    if (format.contains('EEEE')) {
      // EEEE: the full name of week, e.g. Monday
      List<String> weeks = locale.getWeeksFull;
      return format.replaceAll('EEEE', weeks[value - 1]);
    }
    // EEE: the short name of week, e.g. Mon
    List<String> weeks = locale.getWeeksShort;
